...
export class CreateViagemDto {
  @ApiProperty({
    ...
    description: 'Smart Key: YYYYMMDD-ONIBUS-TURNO',
  })
  idViagem: string;
  ...
  @ApiProperty({
    example: 'M',
    description: 'MANHA, TARDE, NOITE (ou M, T, N)',
  })
  turno: string;
  ...
  @ApiProperty({
    example: 40,
    description: 'Capacidade real (pode ser alterada pelo motorista)',
  })
  ...
  @ApiPropertyOptional({
    ...
    description: 'IDs dos líderes (poltronas 1-4)',
  })
  lideresIds?: string[];
}
