CREATE TYPE "public"."accessibility_reason" AS ENUM('PCD', 'TEA', 'IDOSO', 'GESTANTE', 'LACTANTE', 'MOBILIDADE_REDUZIDA');--> statement-breakpoint
CREATE TYPE "public"."accessibility_status" AS ENUM('PENDING_REVIEW', 'APPROVED', 'REJECTED', 'EXPIRED', 'REVOKED');--> statement-breakpoint
ALTER TYPE "public"."registration_status" ADD VALUE 'RENEWAL_PENDING';--> statement-breakpoint
ALTER TYPE "public"."registration_status" ADD VALUE 'SUSPENDED';--> statement-breakpoint
ALTER TYPE "public"."registration_status" ADD VALUE 'INACTIVE';--> statement-breakpoint
